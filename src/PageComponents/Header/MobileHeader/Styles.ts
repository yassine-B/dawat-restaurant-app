export const styles = {
  header_container:
    'absolute z-30 flex flex-row justify-between w-full h-12 bg-gray-200  px-4 items-center',
  ...
  header_navigation_list: 'absolute z-20 w-full bg-primary flex flex-col items-center py-6'
};
